...
const Signup = () => {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gradient-to-b from-gray-900 to-black text-white">
      ...
      <div className="bg-gradient-to-br from-gray-800 to-gray-900 p-10 rounded-3xl shadow-2xl  text-center mt-20 border border-gray-700 transition-all duration-500 hover:shadow-purple-700/30 w-full max-w-md ">
  ...
  <Text label="Email" change={(e) => setUsername(e.target.value)} />
  ...
  className={`w-35 text-lg font-semibold py-2.5 rounded-xl transition-all
    ${
      password.length < 8
